...
export const UnitsTable: React.FC<UnitsTableProps> = ({ selectedUnitSystem, onUnitSystemChange }: UnitsTableProps) => {
  ...
  return (
    <div className={style.unitTableContainer}>
      ...
      <label htmlFor="unitSelect" className={style.unitSelectLabel}>
        Select a unit system for graphing:
        <select id="unitSelect" value={selectedUnitSystem} onChange={handleChange} className={style.unitSelect}>
